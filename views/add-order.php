<div id="content" class="container-fluid px-0">
    <div class="header-content">
        <h3 class="header-title">Tạo đơn hàng</h3>
    ...
    <div class="card mt-2 ml-1">
        <div class="card-body">
            ...
            <form class="form-group order-custorm">
                <input class="form-control" type="search" name="" id="" placeholder="Tìm kiếm theo thông tin khách hàng ...." >
                <button class="search-custorm" ><i class="fas fa-search"></i></button>
            </form>            
            <div class="text-center p-5"  style="margin: auto">
                    <div><img src="image/custormnull.PNG" alt="" srcset=""></div>
    ...
    <div class="card-body">
            ...
            <form class="form-group order-custorm">
                <input class="form-control" type="search" name="" id="" placeholder="Tìm kiếm theo thông tin sản phẩm...." >
                <button class="search-custorm" ><i class="fas fa-search"></i></button>
            </form>           
            <div class="text-center p-5"  style="margin: auto">
                <div><img src="image/productnull.PNG" alt="" srcset=""></div>
