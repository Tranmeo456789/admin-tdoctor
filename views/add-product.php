                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select id="choices-multiple-remove-button" placeholder="Chọn khu vực" multiple>
                                <option value="HTML">Toàn quốc</option>
                                <option value="Jquery">Hà Nội</option>
                                <option value="CSS">TP Hồ Chí Minh</option>
                                <option value="Bootstrap 3">Đà Nẵng</option>                       
                            </select>
                        </div>
                    </div>
                </div>
